...
const WikiItem = ({ page }) => {
  const wikiLink = "http://en.wikipedia.org/?curid=" + page.pageid;

  const lat = page.coordinates[0].lat;
  const lon = page.coordinates[0].lon;
  //   console.log("🚀 ~ Title:", page.title, " WikiItem ~ lat:", lat, " lon:", lon);
  ...
  return (
    <div className="max-w-2xl mx-auto py-1">
      <div className="flex gap-2 bg-background border border-muted-foreground rounded-xl overflow-hidden items-center justify-start">
        <div className="relative pl-2 size-24 flex-shrink-0">
          <img
        ...
        <div className="flex flex-col gap-2 p-1">
          <h4 className="text-md text-primary-foreground font-bold">
            {page.title}
          </h4>
