...
export const ImageZoom = ({
  ...
  <div
    className={cn(
      "relative",
      "**:data-rmiz-ghost:pointer-events-none [&_[data-rmiz-ghost]]:absolute",
  ...
  >
    <Zoom
      classDialog={cn(
        ...
        '[&_[data-rmiz-modal-overlay="visible"]]:bg-background/50 [&_[data-rmiz-modal-overlay="visible"]]:backdrop-blur-md',
